import { type AppwriteConfig, type CollectionCreate, type TableCreate, type TableCreateInput, TableCreateSchema } from "@njdamstra/appwrite-utils";
...
---
*Generated by @njdamstra/appwrite-utils-cli migration tools*
`;
}